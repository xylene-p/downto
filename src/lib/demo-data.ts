...
export const DEMO_EVENTS: Event[] = [
  {
    ...
    isDown: false,
    peopleDown: [
      { name: 'Sara', avatar: 'S', mutual: true, inPool: true },
      { name: 'Nickon', avatar: 'N', mutual: true },
      { name: 'devon.mp3', avatar: 'D', mutual: false, inPool: true },
  ...
  },
  {
    ...
    isDown: false,
    peopleDown: [
      { name: 'Luke', avatar: 'L', mutual: true, inPool: true },
      { name: 'Sara', avatar: 'S', mutual: true },
      { name: 'mx.flora', avatar: 'M', mutual: false, inPool: true },
      { name: 'khai_dances', avatar: 'K', mutual: false, inPool: true },
...
export const DEMO_CHECKS: InterestCheck[] = [
  ...
  },
  {
    ...
    expiresIn: '21h',
    expiryPercent: 12,
    responses: [{ name: 'Sara', avatar: 'S', status: 'down' }],
    viaFriendName: 'Sara',
  },
  {
    id: 'demo-check-3',
...
export const DEMO_SQUADS: Squad[] = [
  {
    ...
    messages: [
      {
        sender: 'Sara',
        text: "ok we're actually doing this right",
        time: '2:34 PM',
      },
      {
        sender: 'Nickon',
        text: 'yup yup, what time we thinking?',
        time: '2:35 PM',
      },
      {
        sender: 'You',
        text: 'i can get there around 11:30?',
        time: '2:38 PM',
        isYou: true,
      },
      {
        sender: 'Sara',
        text: 'perfect. pregame at mine first?',
        time: '2:40 PM',
      },
  ...
  },
  {
    ...
    messages: [
      {
        sender: 'Janelle',
        text: 'this is gonna be so chill',
        time: 'Yesterday',
      },
      {
        sender: 'You',
        text: 'fr, i need it after this week',
        time: 'Yesterday',
        isYou: true,
      },
...
export const DEMO_NOTIFICATIONS: {
...
}[] = [
  {
    id: 'n1',
    type: 'friend_request',
    title: 'Raya wants to be friends',
    body: '@raya_k sent you a request',
    related_user_id: null,
    related_squad_id: null,
  ...
  },
  {
    ...
    type: 'check_response',
    title: 'Sara is down!',
    body: 'Responded to your check "rooftop hangs friday?"',
    related_user_id: null,
    related_squad_id: null,
    related_check_id: null,
    is_read: false,
  ...
  },
  {
    ...
    title: 'Devon accepted your request',
    body: 'You and @devon.mp3 are now friends',
    related_user_id: null,
    related_squad_id: null,
    related_check_id: null,
    is_read: true,
